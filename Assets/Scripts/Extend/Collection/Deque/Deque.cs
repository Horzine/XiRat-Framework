...
namespace Xi.Extend.Collection
{
    ...
    public sealed class Deque<T> : IList<T>, IReadOnlyList<T>, System.Collections.IList
    {
        ...
        public T RemoveFromBack() => IsEmpty ? throw new InvalidOperationException("The deque is empty.") : DoRemoveFromBack();
        ...
        /// <returns>The former first element.</returns>
        /// <exception cref="InvalidOperationException">The deque is empty.</exception>
        public T RemoveFromFront() => IsEmpty ? throw new InvalidOperationException("The deque is empty.") : DoRemoveFromFront();
